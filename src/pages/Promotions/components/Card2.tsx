...
const Card2: FunctionComponent<EventsType> = ({ className = "" }) => {
  ...
  return (
    ...
    <div className="custom-card-frame-498">
        <img className="custom-card-rectangle-10" src="Promotionsimg/scene.png" />
    ...
    <div className="custom-card-frame-496">
      <div className="custom-card-frame-501">
        <div className="custom-card-frame-495">
          <div className="custom-card-_3000">Вітальний бонус до 3000$</div>
        </div>
        <div className="custom-card-frame-555">
          <div className="custom-card-div">Зареєструйся і отримуй бонуси</div>
        </div>
      </div>
      <div className="custom-card-frame-394" onClick={() => handleOpenProfileModal('Funds')}>
        <div className="custom-card-div3">Отримати бонус</div>
      </div>
    </div>
  </div>
  </div>
